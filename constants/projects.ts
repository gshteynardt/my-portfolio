export const projects = [
  {
    id: 7,
    title: 'Date math expression parser',
    type: 'pet',
    description:
      'A lightweight date math expression parser for relative dates, inspired by Grafana and Elasticsearch syntax. Built with a recursive descent parser based on a formal EBNF grammar.',
    image: '/date-math-expression-parser.png',
    tags: [
      'EBNF',
